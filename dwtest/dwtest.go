...
// low PC address and then adding in the high_pc attr offset (doing
// things this way is more compact/efficient: 1 relocation instead of
// 2). This function accepts both styles of specifying a hi/lo pair,
// returning the values or an error if the attributes are malformed in
// some way.
